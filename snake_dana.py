...
turtle.goto(0,200)
turtle.color("red")
turtle.write("The red snake player plays with the arrow keys", font = ("Ariel", 30), align="center")
turtle1.goto(0,100)
turtle1.color("red")
turtle1.write("In addition, he is FASTER than the other", font = ("Ariel", 30), align="center")
turtle2.goto(0,-100)
turtle2.color("green")
turtle2.write("The green snake player plays with the W,S,A,D keys", font = ("Ariel", 28), align="center")
turtle3.goto(0,-200)
turtle3.color("green")
...
def move_snake():
    ...
    if new_x_pos >= RIGHT_EDGE:
        turtle.goto(0,0)
        turtle.write("The red snake hit the right edge! game over!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit()

    elif new_x_pos <= LEFT_EDGE:
        turtle.goto(0,0)
        turtle.write("The red snake hit the left edge! game over!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit()

    elif new_y_pos >= UP_EDGE:
        turtle.goto(0,0)
        turtle.write("The red snake hit the up edge! game over!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit()

    elif new_y_pos <= DOWN_EDGE:
        turtle.goto(0,0)
        turtle.write("The red snake hit the down edge! game over!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit(pos_list)
        
    if pos_list[-1] in pos_list[0:-1]:
        turtle.goto(0,0)
        turtle.write("The red snake hit yourself!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit()
...
def move_snake1():
    ...
    if new_x_pos1 >= RIGHT_EDGE:
        turtle.goto(0,0)
        turtle.color("green")
        turtle.write("The green snake hit the right edge! game over!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit()
        ...
        turtle.goto(0,0)
        turtle.color("green")
        turtle.write("The green snake hit the left edge! game over!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit()
        ...
        turtle.goto(0,0)
        turtle.color("green")
        turtle.write("The green snake hit the up edge! game over!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit()
        ...
        turtle.goto(0,0)
        turtle.color("green")
        turtle.write("The green snake hit the down edge! game over!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit(pos_list)
    ...
    if pos_list1[-1] in pos_list1[0:-1]:
        turtle.goto(0,0)
        turtle.color("green")
        turtle.write("The green snake hit himself!", font = ("Ariel", 30), align="center")
        time.sleep(2)
        quit()
