...
#make turtle listen
turtle.onkeypress(upW, UP_ARROW1)
turtle.onkeypress(leftA, LEFT_ARROW1)
turtle.onkeypress(downS, DOWN_ARROW1)
turtle.onkeypress(rightD, RIGHT_ARROW1)
turtle.listen()
...
def move_snake():
  ...
  if direction1 == RIGHT:
       snake1.goto(x_pos + square_size, y_pos)
       print("You moved right!")
  elif direction1 == LEFT:
        snake1.goto(x_pos - square_size, y_pos)
        print("You moved left!")
  elif direction1 == UP:
        snake1.goto(x_pos, y_pos + square_size)
        print("You moved up!")
    ...
    stamp_list.append(new_stamp1)

    # if the snake is eating food
    if snake.pos1() in food_pos:
        food_ind1 = food_pos1.index(snake.pos1())
        food.clearstamp(food_stamps1[food_ind1])
        food_pos1.pop(food_ind1)
        score.append(food_ind1)
        food_stamps1.pop(food_ind1)
        ...
        snake.clearstamp(old_stamp1)
        pos_list1.pop(0)

    new_pos = snake1.pos()
    new_x_pos = new_pos1[0]
    new_y_pos = new_pos1[1]
...
def make_food1():
    ...
    pos_food1 = (food_x, food_y)
    
    food1.goto(food_x, food_y)
    food_id1 = food.stamp()
    food_stamps1.append(food_id1)
    food_pos1.append(pos_food1)
